...
function Register() {
  ...
  function ListOfRagisterdUsers() {
    ...
    userList.push({
      ...
      username: username,
      password: password,
      isSubscribed: subscribeDetail.isSubscribe,
      plan: subscribeDetail.plan,
      isLogIn: subscribeDetail.isLogin,
    });
    ...
    if (email === "" || username === "" || password === "") {
      ...
      alert(
        "You are successfully Registered, Go to Home page and subscribe to get fit"
      );
      routeChange();
